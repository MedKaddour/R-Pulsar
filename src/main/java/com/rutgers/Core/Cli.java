...
public class Cli {
    ...
    public Cli(String[] args) {
        ...
        options.addOption(l);
        /* This flag is optional and is for encripting the traffic between nodes */ 
        Option t = OptionBuilder.hasArgs(1).withArgName("Trace").withDescription("Send traces to").isRequired(false).withLongOpt("trace").create("t");
        options.addOption(t);
