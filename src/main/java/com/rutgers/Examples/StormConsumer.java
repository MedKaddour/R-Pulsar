...
public class StormConsumer {
    ...
    static ArrayList< String> sentences=null;
        ...
        public void run() {
            while(running) {
                try {
                	...
                	sentences.add(payload);
                	 System.out.println("Received: (" + payload + ") for the "+Collections.frequency(sentences, payload)+" times");
                    ...
                    Logger.getLogger(StormConsumer.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
